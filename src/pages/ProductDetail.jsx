...
const ProductDetail = () => {
  ...
  // 3. ORDER NOW LOGIC (കാർട്ടിലേക്ക് ആഡ് ചെയ്ത് നേരെ ചെക്ക്ഔട്ടിലേക്ക് പോകും)
    ...
    <div className="pt-32 pb-20 px-6 max-w-6xl mx-auto min-h-screen text-white">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
          ...
          <div className="flex flex-wrap items-end gap-12 pt-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center border border-white/10 rounded-[1.5rem] overflow-hidden bg-white/5 backdrop-blur-md">
                <button onClick={handleDecrease} className="px-6 py-4 hover:bg-green-500 hover:text-black transition-all">
                  <FiMinus />
                </button>
                <span className="px-6 py-2 text-2xl font-black min-w-[60px] text-center">{quantity}</span>
                <button onClick={handleIncrease} className="px-6 py-4 hover:bg-green-500 hover:text-black transition-all">
                  <FiPlus />
                </button>
              </div>
            </div>
          ...
          {/* Action Buttons (പുതുക്കിയവ) */}
          <div className="flex flex-wrap gap-4 pt-8">
            <motion.button
              whileHover={{ scale: 1.02, backgroundColor: "#4ade80" }}
              whileTap={{ scale: 0.98 }}
              onClick={handleAddToCart}
              className="flex-1 min-w-[160px] bg-green-500 text-black font-black py-4 px-6 rounded-[2rem] transition-all text-sm sm:text-lg uppercase tracking-widest shadow-2xl shadow-green-500/20 flex items-center justify-center gap-3"
            >
            ...
            <motion.button
              ...
              className="flex-1 min-w-[160px] border-2 border-white text-white font-black py-4 px-6 rounded-[2rem] transition-all text-sm sm:text-lg uppercase tracking-widest flex items-center justify-center gap-3 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
            >
            ...
            <motion.button
              ...
              className="p-4 px-6 border border-white/10 rounded-[2rem] hover:bg-pink-500/10 text-2xl text-gray-400 transition-all flex items-center justify-center"
